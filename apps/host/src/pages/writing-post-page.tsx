    ...
    return (
      <>
        <PageMetadata
          ...
          description="That writing entry is not available. Head back to the writing index and choose another post."
          pathname={slug ? `/writing/${slug}` : '/writing'}
        />
        <PublicPage testId="writing-post-not-found" contentClassName="space-y-4">
  ...
  return (
    <>
      <PageMetadata
        ...
        type="article"
      />
      <PublicPage testId="writing-post-page" contentClassName="space-y-0">
