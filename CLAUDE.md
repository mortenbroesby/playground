...
- Use `jcodemunch` first for code exploration. Keep Astrograph
  (`@mortenbroesby/astrograph`; compatibility bin `ai-context-engine`)
  available in parallel, but treat it as the secondary path.
