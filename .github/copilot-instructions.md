...
- This repo contains a reusable MCP server catalog at `mcp/servers.json`.
- Validate MCP catalog changes with `pnpm mcp:validate`.
- Export client-ready MCP snippets with:
