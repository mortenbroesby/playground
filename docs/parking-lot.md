...
**Idea:** Turn this playground monorepo into a personal website for Morten Broesby-Olsen.
...
- README viewer becomes a blog/writing section
...
- dense framed interfaces
- terminal-adjacent visual language
- polished fictional-operations aesthetic

Do not change the app into a novelty experience. This is still a serious product UI. The goal is:
...
- logs, traces, nodes, signals, consoles, inspectors
...
4. restyle navigation, tables, forms, modals, dashboards, and status elements
5. apply the theme consistently across key screens
